...
if curso_git in cursos_linkedin:
  ...
  notas[curso_git] = int(input('Qual nota você dá para esse curso (0 a 5)? '))
if curso_python in cursos_linkedin:
  print(f'O curso "{curso_python}" está no catálogo. Por favor, avalie o curso.')
  notas[curso_python] = int(input('Qual nota você dá para esse curso (0 a 5)? '))
if curso_r in cursos_linkedin:
  print(f'O curso "{curso_r}" está no catálogo. Por favor, avalie o curso.')
  notas[curso_r] = int(input('Qual nota você dá para esse curso (0 a 5)? '))
else:
  print('Esse curso não está no catálogo')
